...
class HouseModel:
    ...
    def __init__(self, id: int = 0, title: str = "", community: str = "", years: str = "",
                 house_type: str = "", area: float = 0.0, floor: str = "", description: str = "",
                 total_price: float = 0.0, unit_price: float = 0.0, follow_info: str = ""):
        """
            创建房源信息对象
        :param id:编号
        :param title: 标题
    ...
    # 对象 -> 字符串(客户可看懂)
    def __str__(self):
        return f"编号为{self.id}的房源标题是{self.title}。面积是{self.area}..."
